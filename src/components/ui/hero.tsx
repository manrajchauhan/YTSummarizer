export default function Hero() {
  return (
    <div
      ...
      style={{background: "linear-gradient(rgba(0,0,0,0.5), rgba(0,0,0,0.5)), url('/hero.jpg')", backgroundSize: ""}}
    >
      <div className="pt-[200px] pb-10 items-center text-center">
        ...
        <p className="tracking-tight text-white text-xl mb-8">
          Use our advanced tool to extract key points and summaries from YouTube videos, helping you consume content faster.
        </p>
